...
Our movement model needs an error measure such that it can figure out how much to change the generated motion. Hence, we compute $\diffmove_d=||\move_d-\controlmove||$ as the absolute error between the state and control values for movement direction. 
%
...
\begin{subequations}
\begin{align}
    \intermediary\speed&\leftarrow{}\mapt(\angularspeed_d,\diffmove_d,\param_0)\\
