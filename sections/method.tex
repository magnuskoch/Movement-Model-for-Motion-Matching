...
In the following we will introduce a method for optimal synchronization between a Movement Model and a set of animations. There are 4 main part the system. 
...
An animation is a time series of bone positions and rotations ordered in a hierarchy or skeleton in character animation. We define an animated skeleton.
\begin{equation}
    \skeleton=[(\vec{v}_0,\quat{q}_0), \dots, (\vec{v}_b,\quat{q}_b)]
\end{equation}
All 
