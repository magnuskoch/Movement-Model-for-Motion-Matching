...
\quad \forall k \neq g \,.
\end{equation}
We set $\weight_{g,t+1}=\weight_{g,t}+\dweight_g$ and need to maintain both $||\blend||^2=1$ and the distribution of the locomotion modes we are transitioning away from by Both is achieved by.
...
\begin{center}
 ...
 \hline
 t & $$\weight_i$ & $\weight_j$ & $\weight_g$  \\ [0.5] 
 \hline\hline
 0.0 & 0.4 & 0.6 & 0.0 \\ 
 \hline
