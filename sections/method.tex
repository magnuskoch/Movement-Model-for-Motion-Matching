...
The locomotion modes and interpolators are activated through a high level control signal \magnus{movement model generate control signal. This is more like high level intentions} provided by user control input or an AI navigation system. The signal contains no planning and should provide only goals that we wish to achive as fast a possible.  as a concrete example this could defined as follows
\begin{equation}
