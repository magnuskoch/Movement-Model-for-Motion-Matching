...
\magnus{Control genomes are easy to deduce because we use dance card style animations. Usually move straight - perform singke change in direction - move straight. Natural to say that genome has three entries. Starten position/velocity and two directions}      
\magnus{As control genomes approaches animation we end up getting a perfect fit. }
% \begin{figure}
%     \centering
